...
<body>
	...
	<div class="container">
		...
		<div class="main">
			...
			<!-- 회원가입 form -->
			<form id="trans" action="http://localhost:9000/joinservice/crawling"
				method="post" style="width: 37.5rem; margin: 0 auto;">
				<!-- 이메일 -->
				<div class="joinInputDiv">
					<div class="joinInputDiv_1">
						<a>아이디</a>
					</div>
					<div class="joinInputDiv_2">
						<input id="join_id" class="joinInput" name="user_id" type="text"
							placeholder="아이디를 입력하세요.">
					</div>
					<div class="joinInputDiv_3">
						<input class="inputBtn" type="button" value="중복확인"
							onclick='idCheck()'>
					</div>
				...
				<div class="joinInputDiv">
					...
					<div class="joinInputDiv_2">
						<input class="joinInput" name="user_pw" type="password"
				...
				<div class="joinInputDiv">
					...
					<div class="joinInputDiv_2">
						<input class="joinInput" id="insta_id" name="insta_id" type="text"
							placeholder="인스타그램 아이디를 입력하세요.">
					</div>
					<div class="joinInputDiv_3">
						<input class="inputBtn" type="button" value="확인"
							onclick="crawlingNickImg()">
					</div>
				</div>
				<div style="height: 2rem;"></div>
				<!-- 인스타그램 이미지 추출해서 가져오기 -->
