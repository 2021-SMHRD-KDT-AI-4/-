...
<body>
	...
	<div class="container">
		...
		<div class="main">
			...
			<!-- 언팔로우 서비스 설명 -->
			<div
				style="height: 25rem; width: 25rem; margin: auto; border: 0.25rem solid #E95099; background-color: rgba(255, 255, 255, 0.3);">
				<div
			...
			<div style="height: 2.5rem;">
				<button id="trans"
					onclick="location.href = 'http://localhost:9000/inforum/Unfollow?insta_id=<%=insta_id%>'">분석하기</button>
			</div>
			<%
				}
			%>
